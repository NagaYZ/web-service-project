...
public class ConverterServiceLocator extends org.apache.axis.client.Service implements fr.uge.converter.ConverterService {
    ...
    private java.lang.String Converter_address = "http://localhost:8080/Converter/services/Converter";
    ...
    public fr.uge.converter.Converter getConverter() throws javax.xml.rpc.ServiceException {
    ...
    public fr.uge.converter.Converter getConverter(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.uge.converter.ConverterSoapBindingStub _stub = new fr.uge.converter.ConverterSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.uge.converter.Converter.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.uge.converter.ConverterSoapBindingStub _stub = new fr.uge.converter.ConverterSoapBindingStub(new java.net.URL(Converter_address), this);
                _stub.setPortName(getConverterWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://converter.uge.fr", "ConverterService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://converter.uge.fr", "Converter"));
        }
