...
public class BankServiceServiceLocator extends org.apache.axis.client.Service implements fr.uge.bankservice.BankServiceService {
    ...
    public fr.uge.bankservice.BankService getBankService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.uge.bankservice.BankServiceSoapBindingStub _stub = new fr.uge.bankservice.BankServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.uge.bankservice.BankService.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.uge.bankservice.BankServiceSoapBindingStub _stub = new fr.uge.bankservice.BankServiceSoapBindingStub(new java.net.URL(BankService_address), this);
                _stub.setPortName(getBankServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://bankservice.uge.fr", "BankServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://bankservice.uge.fr", "BankService"));
        }
